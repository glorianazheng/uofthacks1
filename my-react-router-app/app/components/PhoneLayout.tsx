  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="bg-white rounded-[50px] shadow-2xl overflow-hidden border-[14px] border-black">
          {/* Screen Content */}
          <div className="bg-white h-[812px] overflow-hidden flex flex-col">
            {/* Status Bar */}
            <div className="bg-white border-b border-gray-200 px-6 py-2 flex justify-between items-center text-sm font-semibold">
              <span>9:41</span>
          ...
          {/* Notch */}
          <div className="absolute top-0 left-1/2 transform -translate-x-1/2 bg-black rounded-b-3xl w-32 h-7"></div>
        </div>
      </div>
    </div>
  );
